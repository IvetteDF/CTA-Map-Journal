...
class EmotionDataViewModel: ObservableObject {
    ...
    func getEmotionScores(title: String, entry: String, link: String, station_name: String, end_station_name: String, analyzeEmotion: Bool) {
        ...
        let dataTask = session.dataTask(with: request as URLRequest) { (data, response, error) -> Void in
            if (error != nil) {
                ...
                journalEntryViewModel.addJournalEntry(title: title, entry: entry, link: link, station_name: station_name, end_station_name: end_station_name, analyzeEmotion: true, emotionScores: self.emotionScores)
