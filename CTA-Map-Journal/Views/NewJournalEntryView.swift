    ...
    var body: some View {
        ...
        VStack {
            ...
            HStack {
                ...
                Button("Submit Entry") {
                    if analyzeEmotion {
                        emotionDataViewModel.getEmotionScores(title: title, entry: entry, link: link, station_name: selectedTrainStation.station_name!, end_station_name:endTrainStationName, analyzeEmotion: analyzeEmotion)
                    } else {
                        journalEntryViewModel.addJournalEntry(title: title, entry: entry, link: link, station_name: selectedTrainStation.station_name!, end_station_name: endTrainStationName)
                    }
                }
