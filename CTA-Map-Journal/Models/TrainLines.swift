...
struct TrainLines {
    ...
    static let themeColors: [String:Color] = [
        "Red": Color("CTARed"),
        "Blue": Color("CTABlue"),
        "Green": Color("CTAGreen"),
        "Brown": Color("CTABrown"),
        "Purple": Color("CTAPurple"),
        "Yellow": Color("CTAYellow"),
        "Pink": Color("CTAPink"),
        "Orange": Color("CTAOrange")]
    static let themeColorsArray: [String] = ["Red", "Blue", "Green", "Brown", "Purple", "Yellow", "Pink", "Orange"]
